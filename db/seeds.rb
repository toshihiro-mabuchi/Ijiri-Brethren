...
Bible.create!(title: "イザヤ書",
              subtitle: "４１章１０節より",
              text: "「恐れるな。わたしはあなたとともにいる。
              たじろぐな。わたしがあなたの神だから。」")

# 変わることなく永遠に続くものってあるの？
Bible.create!(title: "イザヤ書",
              subtitle: "４０章６節から８節より",
              text: "「すべての人は草、 その栄光は、すべて野の花のようだ。
...
Bible.create!(title: "コリントの信徒への手紙一",
              ...
              text: "「愛は寛容であり、愛は親切です。また人をねたみません。
              愛は自慢せず、高慢になりません。
...
Bible.create!(title: "マタイによる福音書",
              subtitle: "７章１２節より",
              text: "「それで、何事でも、 自分にしてもらいたいことは、 ほかの人にもそのようにしなさい。
              これが律法であり預言者です。」")

# 疲れてしまった人へ
Bible.create!(title: "マタイによる福音書",
              subtitle: "１１章２８節より",
              text: "「すべて、疲れた人、 重荷を負っている人は、 わたしのところに来なさい。
              わたしがあなたがたを休ませてあげます。」")

# 男と女、結婚って何だろうか？
Bible.create!(title: "マルコによる福音書",
              subtitle: "１０章６節から９節より",
              text: "「しかし、創造の初めから、 神は、人を男と女に造られたのです。
...
Bible.create!(title: "ヨハネの第一の手紙",
              ...
              text: "「そのあかしとは、神が私たちに永遠のいのちを与えられたということ、 そしてこのいのちが御子のうちにあるということです。
...
Bible.create!(title: "ヨハネの第一の手紙",
              subtitle: "４章１節より",
              text: "「愛する者たち。霊だからといって、みな信じてはいけません。
...
Bible.create!(title: "ローマ人への手紙",
              ...
              text: "「兄弟愛をもって心から互いに愛し合い、 尊敬をもって互いに人を自分よりまさっていると思いなさい。
